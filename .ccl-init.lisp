...
(defun lrsm () (load "/home/bobak/lsp/rsm"))
(defun lql- () (load "/home/bobak/lsp/ql.lisp"))
(defun lql () (load #P"/home/bobak/quicklisp/setup.lisp"))
;(lql) ;just do it 
...
(defun lkm () (load "/home/bobak/lsp/km_2-5-33"))
;(defun lkm () (ql 'km))
...
(defun cgl () (load "/home/bobak/lsp/cg.cl")) ;load cg callgraph
...
;(load "/Users/bobak/Documents/downloads/lang/lsp/asdf/asdf-config.lisp")
 (load "/home/bobak/Documents/downloads/lang/lsp/asdf/asdf-config")
...
(defun ldlspy ()
 (progn
  ...
  (load #p"/home/bobak/Documents/downloads/lang/lsp/code/project/src/lispy-all-0.4/asdf-config.lisp")
...
(defun ltilde ()
  (load "/home/bobak/lsp/tilde.lisp"))
