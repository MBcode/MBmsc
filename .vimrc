...
au BufRead *.l set ft=lisp
au BufRead *.cl set ft=lisp
...
let g:slimv_swank_cmd ='! sbcl --load /home/bobak/quicklisp/dists/quicklisp/software/slime-v2.20/start-swank.lisp &' " 
